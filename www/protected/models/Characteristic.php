...
class Characteristic extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('characteristic_id, characteristic_name', 'required'),
			array('characteristic_id', 'numerical', 'integerOnly'=>true),
			array('characteristic_name', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, characteristic_id, characteristic_name', 'safe', 'on'=>'search'),
		);
	}
