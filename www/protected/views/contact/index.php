...
$this->breadcrumbs=array(
 ...
 $this->pageTitle = 'Veber Technology - Контакты';
 $this->description = 'контакты Veber Technology видеонаблюдения и безопасности';
 $this->keywords = 'Veber Technology, контакты, видеонаблюдение, безопасность';
?>
<div>
		<div class="main">
